...
# This function is used to run the live inference on the model and display the results on the screen
def run_live_inference(model_path, model_type, hidden_size):
    ...
    # 3. Initialize Hand Landmarker to extract the landmarks from the video frames
    ...
    # 4. Setup Rolling Buffer and OpenCV to capture the video from the webcam
    ...
    try:
        while cap.isOpened():
            ...
            cv2.imshow("Gesture Recognition Interface", frame)
